...
void main() {
    ...
    vec3 bottom = mix(mix(bottom_low, bottom_high, u_height), bottom_over, min(transition_to_over * u_over_time, 1.0));
    vec3 top = mix(mix(top_low, top_high, u_height), top_over, min(transition_to_over * u_over_time, 1.0));
